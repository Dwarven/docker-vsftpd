...
addgroup -g 500 -S $FTP_USER
adduser -u 500 -D -G $FTP_USER -h /home/vsftpd/$FTP_USER -s /bin/false  $FTP_USER
echo "$FTP_USER:$FTP_PASS" | /usr/sbin/chpasswd
chown -R $FTP_USER:$FTP_USER /home/vsftpd/

# Building the configuration file
VSFTPD_CONF=/etc/vsftpd/vsftpd.conf
cp -f /etc/vsftpd/vsftpd-base.conf /etc/vsftpd/vsftpd.conf
...
cat << EOB
  **************************************************
  *                                                *
  *    Docker image: dwarven/vsftpd                *
  *    https://github.com/Dwarven/docker-vsftpd    *
  *                                                *
  **************************************************
